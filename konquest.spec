...
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/konquest-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/konquest-23.08.0.tar.xz.sig
...
%prep
%setup -q -n konquest-23.08.0
cd %{_builddir}/konquest-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693003020
mkdir -p clr-build
pushd clr-build
