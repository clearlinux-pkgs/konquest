...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/konquest-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/konquest-23.04.2.tar.xz.sig
...
%prep
%setup -q -n konquest-23.04.2
cd %{_builddir}/konquest-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686513264
mkdir -p clr-build
pushd clr-build
