...
Version  : 23.04.3
Release  : 54
URL      : https://download.kde.org/stable/release-service/23.04.3/src/konquest-23.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/konquest-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/konquest-23.04.3.tar.xz.sig
...
%prep
%setup -q -n konquest-23.04.3
cd %{_builddir}/konquest-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688847845
mkdir -p clr-build
pushd clr-build
