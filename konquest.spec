...
Version  : 18.12.2
Release  : 3
URL      : https://download.kde.org/stable/applications/18.12.2/src/konquest-18.12.2.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.2/src/konquest-18.12.2.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.2/src/konquest-18.12.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1549889363
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
