...
Source0  : https://download.kde.org/stable/applications/18.08.0/src/konquest-18.08.0.tar.xz
Source99 : https://download.kde.org/stable/applications/18.08.0/src/konquest-18.08.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.2 GPL-2.0
Requires: konquest-bin
Requires: konquest-data
Requires: konquest-license
Requires: konquest-locales
...
export LANG=C
export SOURCE_DATE_EPOCH=1535232872
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535232872
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/konquest
cp COPYING %{buildroot}/usr/share/doc/konquest/COPYING
cp COPYING.DOC %{buildroot}/usr/share/doc/konquest/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang konquest
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/konquest/COPYING
/usr/share/doc/konquest/COPYING.DOC
