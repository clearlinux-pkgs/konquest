...
Version  : 24.05.2
Release  : 68
URL      : https://download.kde.org/stable/release-service/24.05.2/src/konquest-24.05.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/konquest-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/konquest-24.05.2.tar.xz.sig
...
%setup -q -n konquest-24.05.2
cd %{_builddir}/konquest-24.05.2
pushd ..
cp -a konquest-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720552612
mkdir -p clr-build
pushd clr-build
