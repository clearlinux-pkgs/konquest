...
Version  : 24.12.2
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.12.2/src/konquest-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/konquest-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/konquest-24.12.2.tar.xz.sig
...
%setup -q -n konquest-24.12.2
cd %{_builddir}/konquest-24.12.2
pushd ..
cp -a konquest-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738962878
mkdir -p clr-build
pushd clr-build
